...
1. Write or remove `hypr-monitor-manager`.
2. Decide `ControlCenter.tsx`'s trigger.
3. Install `wl-clipboard` — cheap fix, unblocks both capture scripts *and* the `cliphist` binds in `keybindings.lua` (found 2026-08-09, same missing package).
